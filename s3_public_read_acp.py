    ...
    for account in craws.accounts:
        try:
            ...
            results['Description'] = 'Granting public &#39;READ_ACP&#39; access to your S3 buckets can allow everyone on the ' +\
                                    'Internet to see who controls your objects. Malicious users can use this information to ' +\
                                    'find S3 objects with misconfigured permissions and implement probing techniques to help ' +\
                                    'them gain access to your S3 data.'
            details = []
            try:
